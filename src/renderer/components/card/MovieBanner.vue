  ...
  >
    ...
    >
      ...
      <div class="mt-4 flex space-x-3 items-center">
        <a
          href="#"
          class="px-5 py-2.5 bg-primary-600 hover:bg-primary-700 rounded-lg text-xs inline-block"
          >Watch</a
        >
        <a href="#" class="p-2.5 bg-gray-800/80 rounded-lg hover:bg-primary-600">
          <svg
